...
A2 = dlmread('/location-to-store-output-files/graphm-0.52/arch/m_adj.csv'); % smaller graph is A2
A1 = dlmread('/location-to-store-output-files/graphm-0.52/arch/s_adj.csv');
...
%dlmwrite('/home/archana/FA_feat_ASAG/code_write/graphm-0.52/arch/new_cost.csv', S1, 'delimiter', ' ')
